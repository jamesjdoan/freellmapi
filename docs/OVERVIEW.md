...
| [IMPERIUM_EXTENSION.md](IMPERIUM_EXTENSION.md) | Imperium fork extension: exact dashboard paths, routing/quota semantics, API and storage ownership, implementation/test map, and separate-branch maintenance workflow. |
| [providers/04-quota-guidance.md](providers/04-quota-guidance.md) | Extension quota-guidance catalogue: provenance, freshness, advisory states, supported application fields and the Codex refresh workflow. |
