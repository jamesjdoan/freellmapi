...
export function GroupHeaderCells({ group, rank, dragHandle, editableRank, onMoveRank, onToggleGroup, allRows, rateUsage, onUnmerge }: {
  group: ModelGroupRow
  rank: number
  dragHandle?: ReactNode
...
export function SortableGroupRow({ group, rank, editableRank, onMoveRank, onToggleGroup, allRows, rateUsage, selected, onSelect, onUnmerge }: {
  group: ModelGroupRow
  rank: number
  editableRank?: boolean
  onMoveRank?: (toRank: number) => void
  ...
  return (
    ...
    >
      ...
      <GroupHeaderCells group={group} rank={rank} dragHandle={handle} editableRank={editableRank} onMoveRank={onMoveRank} onToggleGroup={onToggleGroup} allRows={allRows} rateUsage={rateUsage} onUnmerge={onUnmerge} />
    </tr>
  )
}
